    ...
    render(){
        ...
        return(
            ...
            <div className="card__inputs">
           {
            ...
            <button className={`card__${!this.state.contentVisible ? 'Generate Mad lib' : 'Clear Form'}`} type="submit">{!this.state.contentVisible ? 'Generate Mad lib' : 'Clear Form'}</button>
            {
